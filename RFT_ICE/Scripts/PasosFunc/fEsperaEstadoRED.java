 ...
 * de estado del RED. Además de esperar que el estado sea igual al deseado, el nro de 
 * RED debe ser distinto de blanco, caso contrario sigue esperando que el red aparezca.
 * El número de RED se puede guardar si se agrega la opción +REDValido. Caso contrario el red
 ...
 * el numero de red generado con la reversión con el que está en la variable global.
 * @author SS
