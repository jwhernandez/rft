...
import resources.Scripts.PasosFunc.fComprarPlanCMHelper;
 ...
 * Última modificación: VC 20170421 No reportaba los errores ya que esperaba "No Encontrado" en lugar de NOK
 */

public class fComprarPlanCM extends fComprarPlanCMHelper
{
	public void testMain(Object[] args) 
	{
		...
		if (!args[1].toString().equals("*")){
			if  (ComprarPlan[0].toString().equals("NOK")){ //VC 20170421 No reportaba los errores ya que esperaba "No Encontrado" en lugar de NOK
