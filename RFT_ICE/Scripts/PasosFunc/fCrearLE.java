...
import resources.Scripts.PasosFunc.fCrearLEHelper;
...
/**
 * Description   : Chequear una lista especial. La ingresa desde la pestana de perfiles
 * @since  2016/10/20
 ...
 */
public class fCrearLE extends fCrearLEHelper
{
	public void testMain(Object[] args) throws RationalTestException 
	{
		...
		ListaEsp[4] = dpString("Tramite");

		callScript("Scripts.Comun.CrearLE", ListaEsp);
		...
		if  ((ListaEsp[0].toString().equals("NOK"))){
			...
			//VC 20170524 solo funcionaba para voz
			if (sTipo.toUpperCase().equals("sms"))
				infoPaso(sScriptName, Tipo.DATO,"NomListaEspecial",getNomListaEspecial_SMS());
			else infoPaso(sScriptName, Tipo.DATO,"NomListaEspecial",getNomListaEspecial());
		}
	}
}
