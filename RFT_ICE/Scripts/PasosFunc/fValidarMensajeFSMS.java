...
import resources.Scripts.PasosFunc.fValidarMensajeFSMSHelper;
 ...
 * @since  2015/12/27
 */
public class fValidarMensajeFSMS extends fValidarMensajeFSMSHelper
{
	public void testMain(Object[] args)  throws RationalTestException 
	{
		...
		ValidarMsj[3] = "FavoritoSMS";
		ValidarMsj[4] = args[2].toString();
		callScript("Scripts.Comun.ValidarMensajeSMSFavorito",ValidarMsj);
