 ...
 * Última modificación: VC 20170331 Se agrega la lógica para validar que el número de pedido de siebel coincida con el de SIPV en el IMEI deseado
 */
	...
	public void testMain(Object[] argu) throws RationalTestException
	{
		...
		if (TablaVenta().exists())
		{
			...
			if (rows==1){
				...
				System.out.println("IMEI Reeplazo: " + sReemp + " | Número de pedido SIPV" + sNroPed + " - Número de pedido en Siebel: " + sNumeroPedido);	
				
				if(sNumeroPedido.equals(sNroPed)) argu[0] = "OK";
				else System.out.println("Los números de pedido no coinciden");
			...
			} else argu[1] = "Datos venta más de uno";
