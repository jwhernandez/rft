 ...
 * Ultima modificacion VC 20170405 Se cambia la forma en la que se obtiene la cédula
 */
public class SIPV_ValidarCedula extends SIPV_ValidarCedulaHelper
{
	public void testMain(Object[] argu) throws RationalTestException
	{
		...
		if (IMEI().exists())
		{
			...
			String sCedulaSIPV  = Cedula().getProperty(".value").toString(); // VC 20170405 Se cambia la forma en la que se obtiene la cédula
			System.out.println("La cedula en siebel es " + argu[3] );
			if(sCedulaSIPV.equals(argu[3])){ // VC 20170331 Se valida que la cédula coincida entre siebel y sipv
				argu[0] = "OK";
			...
			} else System.out.println("Error al obtener la cédula Siebel: " + argu[3] + " | SIPV: " + sCedulaSIPV);
