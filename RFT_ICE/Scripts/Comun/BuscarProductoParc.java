...
/**
 * Descripción: Permite seleccionar una linea que contenga la palabra "descuento"
 ...
 * VC 2016/12/28
 * Ultima modificación: VC 27/04/2017 Se corrige error en while para buscarProductoParc
 * Ultima modificación: VC 02/05/2017 Correcciones en la lógica
 */
public class BuscarProductoParc extends BuscarProductoParcHelper 
{
	public void testMain(Object[] argu) throws RationalTestException 
	{
		...
		Boolean Iterar =  true;  
		while (Iterar){
			//encontrado = sProducto.indexOf(sProductoObjetivo); VC 20170502 Se mete dentro del While
			while (i <= irows - 1 && !(encontrado > -1)) {
				...
				sProducto = sProducto.toUpperCase(); //VC 20170502 Sino no funciona la comparación 
				encontrado = sProducto.indexOf(sProductoObjetivo); //VC 20170502
		...
		sProducto = sProducto.toUpperCase();
		//encontrado = sProducto.indexOf(sProductoObjetivo); VC 20170502 Se comenta, si ya lo encontró la variable no puede tener un -1
