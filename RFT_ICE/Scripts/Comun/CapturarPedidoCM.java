 ...
 * @author SS
 * @since  2017/02/14
 * Última modificación VC 20170421 Se agrega lógica para esperar a que se genere el número de pedido
 */
public class CapturarPedidoCM extends CapturarPedidoCMHelper
{
			...
			for (int i=0;i<=1;i++) {
				...
				case "Venta":
					...
					{				   
						...
						boolean nroPedidoGenerado = esperarNroPedido(); //VC 20170421 Espera a que se genere el número de pedido
						...
						if (nroPedidoGenerado) argu[0]="OK"; //VC 20170421 Si se genera el número de pedido se retorna OK
						else argu[0]="NOK"; // VC 20170421 El pedido no se generó, por lo que se tiene que detener el CP
					}
					break;
				case "Desconexión":
	...
	private boolean esperarNroPedido(){
		// VC 20170421 Realiza varios intentos para obtener el número de pedido y valida que no sea null ni esté en blanco
