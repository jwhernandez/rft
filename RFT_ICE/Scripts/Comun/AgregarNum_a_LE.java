 ...
 * Última modificación: VC 20170609 Se obtiene la ruta correcta, ya que el último # es variable
 * VC 20170613 Inactivan los números anteriores porque el que se va a añadir ahora es el que debe quedar como activo 
 *  VC 20170619 Se agrega opción de validar mensajes parciales para los casos en los que el mensaje es variable
 */
public class AgregarNum_a_LE extends AgregarNum_a_LEHelper
{
	public void testMain(Object[] argu) throws RationalTestException
	{
		...
		//  Invoca a Validaciones con los siguientes parámetros:Inactivo().
		...
		// VC 20170613 Inactivan los números anteriores porque el que se va a añadir ahora es el que debe quedar como activo 
		// Se inactiva solo en los casos en los que no es una validación (en el mensaje recibe NA) y en efecto se quiere agregar el número
		try{
			...
			}else System.out.println("No se inactivaron números.");
		} catch(Exception e){
			System.out.println("No se inactivó ningún número.");
		}
		...
		try{
			...
			System.out.println("No se pudo ingresar el número a la LE.");
		}
		...
		if (!(argu[4].toString().equals("NA"))) { 
			...
			// VC 20170619 Se agrega opción de validar mensajes parciales para los casos en los que el mensaje es variable
			// por ejemplo "No se puede cambiar el número de teléfono hasta el 14/7/2017.(SBL-EXL-00151)(SBL-EXL-00151)"
