...
public abstract class CrearREDHelper extends libreria.Accion
{
	 ...
	 */
	protected SiebButtonTestObject CrearRed() 
	{
	 ...
	 * 		RepositoryName : ICECreaRED
	 */
	protected SiebButtonTestObject CrearRed(TestObject anchor, long flags) 
	{
		return new SiebButtonTestObject(
                        getMappedTestObject("CrearRed"), anchor, flags);
	}
	...
	protected CrearREDHelper()
	{
		setScriptName("Scripts.Comun.CrearRED");
	}
