...
public abstract class RefrescarGuardarPedidoHelper extends libreria.Accion
{
	 ...
	 */
	protected SiebApplicationTestObject SiebApplication() 
	{
		return new SiebApplicationTestObject(
                        getMappedTestObject("SiebApplication"));
	}
	/**
	 ...
	 * 		RepositoryName : Siebel Power Communications
	 */
	protected SiebApplicationTestObject SiebApplication(TestObject anchor, long flags) 
	{
		return new SiebApplicationTestObject(
	...
	protected RefrescarGuardarPedidoHelper()
	{
		setScriptName("Scripts.Comun.RefrescarGuardarPedido");
	}
